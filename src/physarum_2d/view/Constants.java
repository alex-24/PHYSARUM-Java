...
public class Constants {
    ...
    public static final Boolean GUI_DRAW_AGENTS = false;
    ...
    public static final int SIMU_OVERRIDE_POPULATION_SIZE = -1;
    ...
    public static final double SIMU_ROTATION_ANGLE = (Math.PI / 8) / Math.PI;
